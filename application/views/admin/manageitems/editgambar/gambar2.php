          ...
          <div class="row">
            ...
            <div class="row">
            	...
            	<div class="col-lg-8">
            		...
            		<?= form_open_multipart('admin/doEditGambar2/'.$produk['id']);?>
            	...
            	<?php if($produk['gambarlarger3'] && $produk['gambar3'] != NULL):?>
				  <div class="form-group">
				    ...
				    <div class="col-sm-10">
				    	<div class="row">
				    		<div class="col-sm-3">
				    		<img src="<?= base_url('assets/img/produk/').$produk['gambar2'];?>" class="img-thumbnail"> 
				    		</div>
				    		<div class="col-sm-9">
				    ...
				    <div class="col-sm-10">
				    	<div class="row">
				    		<div class="col-sm-3">
				    		<img src="<?= base_url('assets/img/produk/').$produk['gambarlarger2'];?>" class="img-thumbnail"> 
				    		</div>
				    		<div class="col-sm-9">
				    			<div class="custom-file">
