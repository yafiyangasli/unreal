        ...
        <div class="row no-gutters">
            ...
            <div class="col-6 offset-sm-1 offset-md-1 col-sm-5 col-md-5 d-none d-sm-block">
                ...
                <div class="sp-wrap">
                    ...
                    <?php if($dproduk['gambarlarger2'] && $dproduk['gambar2'] != NULL):?>
                    <a href="<?php echo base_url();?>assets/img/produk/<?php echo $dproduk['gambarlarger2'];?>"><img src="<?php echo base_url();?>assets/img/produk/<?php echo $dproduk['gambar2'];?>" alt=""></a>
                    <?php endif;
                    if($dproduk['gambarlarger3'] && $dproduk['gambar3'] != NULL):?>
                    <a href="<?php echo base_url();?>assets/img/produk/<?php echo $dproduk['gambarlarger3'];?>"><img src="<?php echo base_url();?>assets/img/produk/<?php echo $dproduk['gambar3'];?>" alt=""></a>
                    <?php endif;?>
                </div>
            </div>
